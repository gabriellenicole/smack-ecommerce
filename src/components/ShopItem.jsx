...
export default function ShopItem({ imgSrc }) {
  return (
    <div className='flex flex-col gap-y-1 px-5 py-5 rounded-lg border-2 border-black border-opacity-5 ml-5 mb-10 shadow-md'>
      <img className='w-80' src={imgSrc}></img>
      <h1 className='font-semibold text-lg'>Dark Chocolate Chip Soft Cookie</h1>
      <p className='text-black text-opacity-70 text-sm font-medium'>
        Soft-baked, rich chocolate.
      </p>
      <p className='font-medium text-lg'>$96</p>
      <button className='rounded-full w-14 h-14 bg-orange ml-auto hover:bg-opacity-90 shadow-md focus:ring-4 focus:ring-limegreen'>
